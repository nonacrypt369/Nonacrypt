        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-3 text-base text-slate-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl mb-10 max-w-2xl">
              Transform your raw data into actionable insights. Our comprehensive data and analytics services help you build a data-driven culture, optimize operations, and uncover new revenue streams.
            </p>
            <button 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-slate-600">
              We provide end-to-end analytics solutions tailored to your business needs.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Interactive dashboards and reports that provide real-time visibility into your key performance indicators."
              },
              {
                icon: Database,
                title: "Data Warehousing",
                description: "Centralized, scalable data repositories designed for high-performance querying and reporting."
              },
              {
                icon: LineChart,
                title: "Predictive Analytics",
                description: "Forecast future trends and behaviors using historical data and advanced statistical algorithms."
              },
              {
                icon: PieChart,
                title: "Customer Analytics",
                description: "Deep dive into customer behavior, segmentation, and lifetime value to drive personalized experiences."
              }
            ].map((item, index) => (
              <motion.div
                key={item.title}
